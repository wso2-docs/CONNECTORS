...
public class ISO8583ConnectionHandler {
    ...
    public ISO8583ConnectionHandler(Socket socket) throws IOException, ISOException {
    ...
    private String unpackRequest(String message) throws ISOException {
